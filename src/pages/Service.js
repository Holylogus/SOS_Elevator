      ...
      <div className="services">
        <section id="karbantartas">
          ...
          <p className="content">
            ...
            <strong>
              {" "}
              A SOS Elevator Kft. karbantartási szolgáltatásai garantálják, hogy
              rendszerei hosszú távon megbízhatóan és hatékonyan üzemeljenek.
            </strong>
          </p>
          <h5 className="Why">
            Miért válassza karbantartási szolgáltatásainkat?
          </h5>
          <ul>
            <li>
              <strong>Szakértői támogatás: </strong>Képzett technikusaink modern
              eszközökkel végzik a karbantartást, hogy csökkentsék a
            ...
            <li>
              <strong>Gazdaságos működés: </strong>A karbantartással elkerülheti
              a költséges javításokat, és biztosíthatja rendszerei
          ...
          <ol>
            <li>
              <strong>Állapotfelmérés: </strong>Rendszerei jelenlegi állapotának
              alapos elemzése.
            </li>
            <li>
            ...
            <li>
              <strong>Rendszeres ellenőrzések: </strong>Az ütemezett vizsgálatok
              biztosítják a folyamatos, problémamentes üzemelést.
            </li>
          </ol>
          <p className="ending">
        ...
        <section id="szerviz">
          ...
          <h5 className="Why">Miért válassza szervizszolgáltatásunkat?</h5>
          <ul>
            <li>
          ...
          <p className="ending">
            <strong>
              Forduljon hozzánk bizalommal, és biztosítsa rendszerei zavartalan
              működését a legjobb szakértők segítségével!
            </strong>
          </p>
        </section>
        <section id="modernizacio">
          ...
          <p className="content">
            ...
            mozgólépcsők energiahatékonyabbak, megbízhatóbbak és kényelmesebbek
            lesznek mindennapi használatra. A modernizáció során korszerű
            vezérlőrendszereket, energiatakarékos megoldásokat és intelligens
          ...
          <ul className="WhyUl">
            ...
            <li>
              <strong>Biztonság: </strong>Korszerűsített biztonsági rendszerek a
              zavartalan és balesetmentes működésért.
            </li>
            <li>
